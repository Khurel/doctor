...
import 'package:doctor/login_page/login_page_widget.dart';
import 'flutter_flow/flutter_flow_theme.dart';
...
class _MyAppState extends State<MyApp> {
  Locale _locale;
  Stream<DoctorFirebaseUser> userStream;
  DoctorFirebaseUser initialUser;
  ...
  void initState() {
    super.initState();
    userStream = doctorFirebaseUserStream()
